...
{
 "use strict";
 var Global,SPA1,Client,WebSharper,UI,An,EndPoint,SPA1_Router,SPA1_Templates,Router,Operators,Unchecked,System,Guid,Obj,List,T,Var,Model,TODO,View,Arrays,AttrModule,AttrProxy,Templating,Runtime,Server,Handler,TemplateInstance,Event,UIEvent,Message,Anims,Sitelets,RouterOperators,Route,RouterModule,EventTarget,Utils,Node,Abbrev,Fresh,SC$1,Numeric,Doc,JavaScript,Pervasives,Snap,Attrs,DomUtility,Array,Collections,Dictionary,HashSet,Client$1,Seq,SC$2,JSModule,Router$1,List$1,ConcreteVar,Strings,Docs,DynamicAttrNode,Object,DictionaryUtil,Enumerator,T$1,Easing,FSharpMap,Map,Lazy,SC$3,SC$4,SC$5,Mailbox,BalancedTree,Tree,Pair,LazyExtensionsProxy,LazyRecord,PathUtil,List$2,DocElemNode,CharacterData,SC$6,CheckedInput,Slice,Elt,Client$2,Docs$1,RunState,NodeSet,HashSetUtil,MapUtil,Attrs$1,Dyn,Queue,String,Updates,Concurrency,AppendList,Char,AsyncBody,SC$7,CT,HashSet$1,Scheduler,CancellationTokenSource,OperationCanceledException,SC$8,DomNodes,console,Math,IntelliFactory,Runtime$1,$,Date;
 Global=window;
 SPA1=Global.SPA1=Global.SPA1||{};
 Client=SPA1.Client=SPA1.Client||{};
 WebSharper=Global.WebSharper=Global.WebSharper||{};
 UI=WebSharper.UI=WebSharper.UI||{};
 An=UI.An=UI.An||{};
 EndPoint=Client.EndPoint=Client.EndPoint||{};
 SPA1_Router=Global.SPA1_Router=Global.SPA1_Router||{};
 SPA1_Templates=Global.SPA1_Templates=Global.SPA1_Templates||{};
 ...
 T=List.T=List.T||{};
 Var=UI.Var=UI.Var||{};
 Model=Client.Model=Client.Model||{};
 TODO=Client.TODO=Client.TODO||{};
 ...
 SC$2=Global.StartupCode$WebSharper_UI$Animation=Global.StartupCode$WebSharper_UI$Animation||{};
 ...
 List$2=UI.List=UI.List||{};
 DocElemNode=UI.DocElemNode=UI.DocElemNode||{};
 CharacterData=Global.CharacterData;
 SC$6=Global.StartupCode$WebSharper_UI$Doc_Client=Global.StartupCode$WebSharper_UI$Doc_Client||{};
 ...
 {
  var location,p,t,p$1,p$2,p$3,t$1,t$2,$1,c,ti,ti$1,ti$2,r,p$4;
  function f(a)
  {
   Client.update(Client.model(),Message.ClearCompleted);
  }
  function f$1(e)
  {
   Client.update(Client.model(),{
    $:3,
    $0:!e.Vars.Hole("isselected").Get()
   });
  }
  function f$2(e)
  {
   if(e.Event.key==="Enter")
    {
     Client.update(Client.model(),{
      $:0,
      $0:e.Vars.Hole("task").Get()
     });
     e.Vars.Hole("task").Set("");
    }
  }
  function f$3(e)
  {
   var i,$2;
   for(i=1,$2=1000;i<=$2;i++)Client.update(Client.model(),{
    $:0,
    $0:(function($3)
    {
     return function($4)
     {
      return $3("Do task #"+Global.String($4));
     };
    }(Global.id))(i)
   });
   Client.update(Client.model(),{
  ...
  An.set_UseAnimations(false);
  location=Router.InstallHash(EndPoint.All,SPA1_Router.r());
  Doc.RunById("main",(p=(t=(p$1=(p$2=(p$3=(t$1=(t$2=($1=[null],[$1,(c=Guid.NewGuid(),Global.String(c)),new T({
   $:1,
   $0:{
    $:5,
    $0:"clearcompleted",
   ...
   $1:new T({
    ...
    $0:{
     $:0,
     $0:"todos",
     $1:Doc.ConvertSeqVarBy(function(t$3)
     {
      return t$3.Id;
     },function(todo)
     {
      var p$5,t$3,t$4,t$5,p$6,$2,c$1,$3,ti$3,ti$4,ti$5,r$1,p$7;
      function f$4(a)
      {
       Client.update(Client.model(),{
        $:1,
      ...
      function f$5(e)
      {
       e.Vars.Hole("task").Set(todo.Get().Task);
       Client.update(Client.model(),{
        $:4,
        $0:todo
       });
      ...
      function f$6(e)
      {
       e.Event.key==="Enter"?Client.update(Client.model(),{
        $:5,
        $0:todo,
        $1:e.Vars.Hole("task").Get()
       }):void 0;
       e.Event.key==="Escape"||e.Event.key==="Enter"?Var.Lens(todo,function($4)
       {
        return $4.IsEdited;
       },function($4,$5)
       {
        return TODO.New($4.Id,$4.Task,$4.IsCompleted,$5);
       }).Set(false):void 0;
       e.Event.preventDefault();
      }
      return(p$5=(t$3=(t$4=(t$5=(p$6=($2=(c$1=Guid.NewGuid(),Global.String(c$1)),($3=new T({
       $:1,
       $0:{
        $:0,
        $0:"label",
        $1:Doc.TextView(View.Map(function($4)
        {
         return $4.Task;
        },todo.get_View()))
       },
       ...
       $0:{
        $:3,
        $0:"cssattrs",
        $1:AttrProxy.Concat(List.ofArray([AttrModule.DynamicClassPred("completed",View.Map(function($4)
        {
         return $4.IsCompleted;
        },todo.get_View())),AttrModule.DynamicClassPred("editing",View.Map(function($4)
        {
         return $4.IsEdited;
        },todo.get_View())),AttrModule.DynamicClassPred("hidden",View.Map2(function($4,$5)
        {
         return $4.$==2?!$5.IsCompleted:$4.$==1&&$5.IsCompleted;
        },location.get_View(),todo.get_View()))]))
       },
       $1:$3
      })])),[p$6[0],p$6[1],new T({
       $:1,
       $0:{
        $:8,
        $0:"ischecked",
        $1:Var.Lens(todo,function($4)
        {
         return $4.IsCompleted;
        },function($4,$5)
        {
         return TODO.New($4.Id,$4.Task,$5,$4.IsEdited);
        })
       },
       $1:p$6[2]
      })]),[t$5[0],t$5[1],new T({
       ...
       $1:t$3[2]
      })]),(r$1=p$5[0],(p$7=Handler.CompleteHoles(p$5[1],p$5[2],[["ischecked",2],["task",0]]),(r$1[0]=new TemplateInstance.New(p$7[1],SPA1_Templates.todo(p$7[0])),r$1[0])))).get_Doc();
     },Var.Lens(Client.model(),function($2)
     {
      return $2.TODOs;
     },function($2,$3)
     {
      return Model.New($2.Counter,$3);
     }))
    },
    $1:T.Empty
   })
   ...
   $0:{
    $:3,
    $0:"cssfilterall",
    $1:AttrModule.DynamicClassPred("selected",View.Map(function($2)
    {
     return $2.$===0;
    },location.get_View()))
   },
   ...
   $1:t[2]
  })]),(r=p[0],(p$4=Handler.CompleteHoles(p[1],p[2],[["task",0],["isselected",2]]),(r[0]=new TemplateInstance.New(p$4[1],SPA1_Templates.main(p$4[0])),r[0])))).get_Doc());
 };
 Client.model=function()
 {
  SC$1.$cctor();
  return SC$1.model;
 };
 Client.update=function(model,a)
 {
  var o;
  if(a.$==1)
   model.Set(model.Get().RemoveTodo(a.$0.Get().Id));
  else
   if(a.$==2)
    model.Set(model.Get().RemoveCompleted());
   else
    if(a.$==3)
     model.Set(model.Get().UpdateAllTo(a.$0));
    else
     if(a.$==4)
      {
       o=Var.Lens(a.$0,function($1)
       {
        return $1.IsEdited;
       },function($1,$2)
       {
        return TODO.New($1.Id,$1.Task,$1.IsCompleted,$2);
       });
       o.Set(!o.Get());
      }
     else
      if(a.$==5)
       Var.Lens(a.$0,function($1)
       {
        return $1.Task;
       },function($1,$2)
       {
        return TODO.New($1.Id,$2,$1.IsCompleted,$1.IsEdited);
       }).Set(a.$1);
      else
       model.Set(model.Get().AddTodo(a.$0));
 };
 ...
 SPA1_Templates.main=function(h)
 {
  Doc.LoadLocalTemplates("index");
  return h?Doc.NamedTemplate("index",{
   $:1,
 ...
 Router.InstallHash=function(onParseError,router)
 {
  ...
  Global.jQuery(Global.document.body).click(function(ev)
  {
   var m,target,href,m$1;
   m=Global.jQuery(ev.target).closest("a").toArray();
  ...
  return View.MapSeqCachedViewBy(getKey,function(k,v)
  {
   ...
   return f(($1=new Var({
    ...
    Set:function(v$1)
    {
     ...
     {
      return List$2.replaceFirst(isThis,f$1,l);
     });
    },
    ...
    UpdateMaybe:function(f$1)
    {
     return _var.Update(function(l)
     {
      return List$2.maybeReplaceFirst(isThis,f$1,l);
     });
    },
    get_View:function()
    {
 ...
 Model=Client.Model=Runtime$1.Class({
  RemoveTodo:function(id)
  {
   return Model.New(this.Counter,List.filter(function(todo)
   {
    return todo.Id!==id;
   },this.TODOs));
  },
  ...
  UpdateAllTo:function(c)
  {
   return Model.New(this.Counter,List.map(function(todo)
   {
    return todo.UpdateCompleted(c);
   },this.TODOs));
  },
  AddTodo:function(task)
  {
   ...
   return Model.New(counter,List.append(this.TODOs,List.ofArray([TODO.New(counter,task,false,false)])));
  }
 },null,Model);
 Model.get_Empty=function()
 {
  return Model.New(0,T.Empty);
 };
 Model.New=function(Counter,TODOs)
 {
  return new Model({
   Counter:Counter,
   TODOs:TODOs
 ...
 TODO=Client.TODO=Runtime$1.Class({
  UpdateCompleted:function(c)
  {
   return TODO.New(this.Id,this.Task,c,this.IsEdited);
  }
 },null,TODO);
 TODO.New=function(Id,Task,IsCompleted,IsEdited)
 {
  return new TODO({
   Id:Id,
   Task:Task,
 ...
 {
  SC$2.$cctor();
  SC$2.UseAnimations=$1;
 };
 Anims.UseAnimations=function()
 {
  SC$2.$cctor();
  return SC$2.UseAnimations;
 };
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.model=Var.Create$1(Model.get_Empty());
 };
 ...
 SC$2.$cctor=function()
 {
  ...
  SC$2.CubicInOut=Easing.Custom(function(t)
  {
   var t2;
   t2=t*t;
   return 3*t2-2*(t2*t);
  });
  SC$2.UseAnimations=true;
 };
 ...
 List$2.replaceFirst=function(k,f,l)
 {
  var didIt;
  didIt=[false];
 ...
 List$2.maybeReplaceFirst=function(k,f,l)
 {
  var didIt;
  didIt=[false];
  return List.map(function(x)
